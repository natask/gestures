...
- breakdown ::
  - pinch_deadzone_enabled ::
    - enables pinch. It can be set globally for all devices and/or specifically for a device. specific defination overrides global defination.
...
- Syntactic issues in Config file ::
  ...
  - To use them though, you will need to remove all comments and change ="" to ''= from the config file. run the following code in a python shell to get a valid version. Then copy paste the results to any JSON linter.
    ...
    "3": {
        ...
        "r" : {"start": ["xdotool keydown alt", "xdotool key Tab"], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool keyup alt"], "rep": ""},
    ...
    "4": {
        ...
        "l" : {"start": ["xdotool keydown ctrl+alt", "xdotool key Right"],"update": {"l": ["xdotool key Left"], "r": ["xdotool key Right"], "u": ["xdotool key Up"], "d": ["xdotool key Down"], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool keyup ctrl+alt"], "rep": ""},
        "r" : {"start": ["xdotool keydown ctrl+alt", "xdotool key Left"], "update": {"l" :[], "r" :[], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": [], "rep": ""},
        "u" : {"start": ["xdotool keydown ctrl+alt", "xdotool key Up"], "update": {"l" :[], "r" :[], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": [], "rep": ""},
        "d" : {"start": ["xdotool keydown ctrl+alt", "xdotool key Down"], "update": {"l" :[], "r" :[], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": [], "rep": ""},
    ...
    "5": {
        "t" : ["open_dictionary"],
        "u" : {"start": [], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool key super+1"], "rep": ""},
        "ru": {"start": [], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool key super+4"], "rep": ""},
        "r" : {"start": [], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool key super+2"], "rep": ""},
        "rd": {"start": [], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool key super+5"], "rep": ""},
        "d" : {"start": [], "update": {"l": [], "r": [], "u": [], "d": [], "lu": [], "rd": [], "ld": [], "ru": []}, "end": ["xdotool key super+3"], "rep": ""},
     ...
     "2": {
        "i" : {"start": ["xdotool keydown control", "zoom-in-type"], "update": {"i": ["zoom-in-type"], "o": ["xdotool key minus"]}, "end": ["xdotool keyup ctrl"], "rep": ""},
        "o" : {"start": ["xdotool keydown control", "xdotool key minus"], "update": {"i": ["zoom-in-type"], "o": ["xdotool key minus"]}, "end": ["xdotool keyup ctrl"], "rep": ""}
     },
     "3": {
