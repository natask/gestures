...
:END:
:LOGBOOK:
- State "TODO"       from "TODO"       [2020-06-12 Fri 03:32:55]
...
:END:
** TODO setup read the docs
:PROPERTIES:
:ID:       4198e031-5e85-4796-8e95-8b39d66472b8
:END:
:RESOURCES:
:END:
:LOGBOOK:
- Newly Created           [2020-06-12 Fri 03:32:44]
:END:
:NOTES:
- [[https://gitlab.freedesktop.org/libinput/libinput/-/issues/new?issue%5Bassignee_id%5D=&issue%5Bmilestone_id%5D=][New Issue · libinput / libinput · GitLab]]
- [[https://gitlab.freedesktop.org/libinput/libinput/-/issues/422][touchpad stops responding to touch after mempressure/swap event (#422) · Issues · libinput / libinput · GitLab]]
